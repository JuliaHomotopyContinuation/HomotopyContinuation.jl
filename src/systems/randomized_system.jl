...
RandomizedSystem(F::System, A::Matrix{ComplexF64}; compile::Union{Bool,Symbol} = COMPILE_DEFAULT[]) =
...
of variables of `F`.
"""
square_up(F::Union{AbstractSystem,System}; compile::Union{Bool,Symbol} = COMPILE_DEFAULT[]) =
