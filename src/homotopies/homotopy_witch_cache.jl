...
@propagate_inbounds evaluate!(u, H::HomotopyWithCache, x, t, ::HNC=HNC()) = evaluate!(u, H.homotopy, x, t, H.cache)
jacobian(H::HomotopyWithCache, x, t, ::HNC=HNC()) = jacobian(H.homotopy, x, t, H.cache)
@propagate_inbounds jacobian!(U, H::HomotopyWithCache, x, t, ::HNC=HNC()) = jacobian!(U, H.homotopy, x, t, H.cache)
dt(H::HomotopyWithCache, x, t, ::HNC=HNC()) = dt(H.homotopy, x, t, H.cache)
@propagate_inbounds dt!(u, H::HomotopyWithCache, x, t, ::HNC=HNC()) = dt!(u, H.homotopy, x, t, H.cache)
