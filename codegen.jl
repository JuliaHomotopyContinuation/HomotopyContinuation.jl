...
function _div_taylor_impl(N, M)
    ...
    quote
        $(Expr(:tuple, :a, (Symbol(:a,k) for k in 1:N)...)) = a
        $(Expr(:tuple, :b, (Symbol(:b,k) for k in 1:N)...)) = b
...
AS = (randn(ComplexF64, 7), randn(ComplexF64, 7), randn(ComplexF64,7), randn(ComplexF64,7), randn(ComplexF64,7))
BS = (randn(ComplexF64, 7), randn(ComplexF64,7), randn(ComplexF64,7), randn(ComplexF64,7), randn(ComplexF64,7))
us = (randn(ComplexF64, 7), randn(ComplexF64,7), randn(ComplexF64,7), randn(ComplexF64,7), randn(ComplexF64,7))
