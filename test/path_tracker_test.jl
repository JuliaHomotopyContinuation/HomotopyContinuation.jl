@testset "PathTracker" begin
    ...
    @testset "Simple" begin
        ...
        tracker, starts =
            pathtracker_startsolutions(f; projective_tracking = true, system = FPSystem)
    ...
    @testset "track with parameters change" begin
        ...
        p₀ = [2, 4]
        res =
            track(tracker, starts[1]; start_parameters = [1, 0], target_parameters = [2, 4])
