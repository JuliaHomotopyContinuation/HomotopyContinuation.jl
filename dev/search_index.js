...
{
    "location": "solving/#Base.real-Tuple{Union{Result, Array{#s111,1} where #s111<:PathResult}}",
    "page": "Solving Polynomial Systems",
    "title": "Base.real",
    "category": "method",
...
{
    "location": "solving/#HomotopyContinuation.Monodromy.complex_conjugation",
    "page": "Solving Polynomial Systems",
    "title": "HomotopyContinuation.Monodromy.complex_conjugation",
    "category": "function",
...

{
    ...
    "category": "function",
    "text": "pathtracker(args...; kwargs...)\n\nConstruct a PathTracking.PathTracker in the same way solve does it. This als0 takes the same input arguments as solve. This is convenient if you want to investigate single paths.\n\n\n\n\n\n"
},
...

{
    ...
    "title": "Methods",
    "category": "section",
    "text": "To track from a start to an endpoint with the PathTracker we provide the following routines.PathTracking.track\nPathTracking.track!\nPathTracking.setup!It is also possible to use a PathTracker as an iterator:iterator!To introspect the current state and change settings we provide the following routines.currx\ncurrt\ncurrΔt\ncurriters\ncurrstatus\ntol\ncorrector_maxiters\nrefinement_tol\nrefinement_maxiters\nset_tol!\nset_corrector_maxiters!\nset_refinement_tol!\nset_refinement_maxiters!"
},
